...
var cnItems = {
    ...
    "damageTaken": "受到的伤害",
    "Activity EXP:": "活跃经验：",
    "% increased gain.": "% 提高的增益.",
    "AoE: also hits other targets in that range.": "AoE：同时击中该范围内的其他目标。",
    "Credits": "鸣谢",
    ...
    "Total softcap:": "总计软上限:",
    "Reset\n                            Area": "重置区域",
    "Reset\n                            Automation Upgrades": "重置自动化升级",
    "Preview": "预览",
    "Level:": "等级:",
    "LIMITS": "限制",
    "Lost": "失败",
    "Music & Many Backgrounds, Luis Zuno,": "音乐与许多背景，Luis Zuno，",
    "Class": "种族",种族
    "Do parkour": "跑酷",
    "Overtraining": "过度训练",
    "hit Hero with": "命中英雄通过",
    "Going over your limits is hard, and every second you don't spend\n                                    training you lose some of your power over the limit.\n                                    For every attribute point you lose this way, you gain a permanent bonus. This bonus\n                                    is stronger the less attributes you have, reaching a minimum when you reach your\n                                    limit.": "超越你的极限是很难的，每一秒钟你不花时间训练，你就会失去一些超越极限的力量。你以这种方式失去的每一个属性点，你将获得一个永久奖励。你拥有的属性越少，这个奖励越强，当你达到你的\n极限时，这个奖励就会达到最小值。",
    "I WANT TO BE THE STRONGEST HERO!": "我要成为最强大的英雄！",
    "giving": "给予",
    "Bonus Passive Points:": "奖励被动点数:",
    "Attribute Gain:": "属性增益:",
    "Player defeated, resting.": "玩家被打败，开始休息。",
    "You will take some time away from fighting crime to dig deeper into what your powers can do.\n                                    You lose all your levels when you class prestige, keeping limits (forces an\n                                    attribute prestige)": "你将从打击犯罪中抽出一些时间来深入挖掘你的能力。当你设置声望时，你会失去所有的等级，保持限制（强制一个属性声望）",
    "Your class prestige bonus will become:": "你的种族声望奖励将变成：",
    "Prestige your class to gain even more power to become the most\n                                    powerful hero": "声望你的种族获得更多的力量，成为最强大的英雄",
    "Prestiging will also unlock more passives and abilities in each subclass:": "声望也会在每个子类中解锁更多的被动和技能：",
    "Repeat: Chance to use again without cooldown. Successive repeats half the chance.": "重复：有机会在没有冷却的情况下再次使用。连续重复只有一半的机会。",
    "Rush: moves along with attacking.": "突进：随着攻击移动。",
    "You can reset your point allocation by Rebranding (requires double click). WARNING! This\n                                costs 1% of your current reputation!": "你可以通过重命名重置你的点数分配（需要双击）。警告!这将花费你当前声誉的1% ！",
    "You can take the Y you found to unlock\n                                    more of your power.": "你可以用你找到的Y来解锁更多的力量。",
    "You gain 1% of the limit as permanent attributes when you reset this way. (They\n                                    cannot be lowered below that value by activities)": "当你重置时，你将获得上限的1%作为永久属性。（它们不能因活动而降低到该值以下）",
    "Your limit will increase to their current value above the limit (limit cannot\n                                    decrease).": "您的限制将增加到当前的值超过限制（限制不能\n降低）。",
    "": "",
    "": "",
    "": "",
    "": "",
